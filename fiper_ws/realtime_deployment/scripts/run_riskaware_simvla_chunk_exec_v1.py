...
def main():
    ...
    risk_model = SeqRiskModel("transformer", 21, 7, 43, width=risk_config.get("width", 128), layers=risk_config.get("layers", 3), heads=risk_config.get("heads", 4), dropout=0.0).to(device)
