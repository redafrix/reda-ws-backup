...
## Online Cross-Suite Argmin-Cap Replay (Bob, 2026-07-09)

This is the online deployment companion to the strict cross-suite official OOD campaign. It uses the same replayed official-suite episodes as the offline datasets and compares original SimVLA H10 against the promoted TopK8 risk-aware argmin-cap policy.

| Property | Value |
| :--- | :--- |
| **Experiment ID** | `online_cross_suite_argmin_caps_20260709` |
| **Report** | `/media/rootalkhatib/My Passport/reda_ws/fiper_ws/cross_suite_official_ood_20260630/experiments/online_cross_suite_argmin_caps_20260709/ONLINE_CROSS_SUITE_ARGMIN_CAPS_SUMMARY.md` |
| **Baseline** | Original SimVLA H10 |
| **Risk policy** | Modified SimVLA `ckpt-60000` + promoted `simvla_h10_topk8_official_goal_object_seen_main_20260701` + argmin-cap action replacement |
| **ACE metric style** | `new_training` |
| **Episodes** | 680 paired online episodes across six datasets |
| **Timeout** | 300 steps |
| **Result** | Original SimVLA 392/680 = 57.65%; risk-aware 403/680 = 59.26%; net +11 successes |
...
| Dataset | Original SimVLA H10 | Risk-aware argmin-cap H10 | Net change | Risk action changes |
| :--- | ---: | ---: | ---: | ---: |
| `goal_object_ood_180` | 165/180 = 91.67% | 171/180 = 95.00% | +6 | 508 |
| `goal_swap_100` | 2/100 = 2.00% | 3/100 = 3.00% | +1 | 667 |
| `goal_task_100` | 2/100 = 2.00% | 2/100 = 2.00% | 0 | 770 |
| `spatial_object_100` | 95/100 = 95.00% | 99/100 = 99.00% | +4 | 48 |
| `object_object_100` | 89/100 = 89.00% | 90/100 = 90.00% | +1 | 103 |
| `libero10_object_100` | 39/100 = 39.00% | 38/100 = 38.00% | -1 | 433 |
| **Total** | **392/680 = 57.65%** | **403/680 = 59.26%** | **+11** | **2529** |

Interpretation: trusted online evidence that the action-risk score can improve real closed-loop success under paired replay, but the effect is suite-dependent. The policy is strongest on `goal_object_ood_180` and `spatial_object_100`, neutral on `goal_task_100`, and slightly negative on `libero10_object_100`.
