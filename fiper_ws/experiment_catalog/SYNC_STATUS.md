...
|---|---|---|---|
| Batman | Canonical catalog present and updated (2026-06-16) | Obsidian report consolidated. Local reports/configs, forensic audit scripts in `/checks/`. | Available |
| Bob | Full catalog mirror synchronized on 2026-06-16. | OOD 0.3/0.5/q95 sweeps and selected-cap comparisons complete. Best 300-step Bob selected-cap variant is delay30: 1,723/1,800 (+5 vs Modified). | Available through `pcrobot` |
