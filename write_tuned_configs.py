...
launch_path = Path("/home/dean/fiper_uncertainty_collection/realtime_deployment/scripts/launch_tuned_topk8_pilot_20260605_dean.sh")
launch_path.write_text(launch_script_content)
launch_path.chmod(0o755)
print("Created launch script on Dean and made it executable.")
