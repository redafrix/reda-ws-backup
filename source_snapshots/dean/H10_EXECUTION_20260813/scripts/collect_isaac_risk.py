#!/usr/bin/env python3
"""Guarded real-Isaac SimVLA risk-data collector."""
...
from risk_collection.runtime_policy import RiskCollectionPlanner, RiskDecisionPlan  # noqa: E402
...
def require_gpu_safe() -> None:
    ...
    rollouts = process_matches("simvla_reaching_rollout.py") + process_matches(
        ...
        while simulation_app.is_running() and step < int(collection_cfg["max_steps"]):
            ...
            if is_control_tick:
                if current_actions is None or current_action_index >= len(current_actions):
                    ...
                    current_actions = current_plan.main_chunk_env
                    current_action_index = 0
                    current_executed = []
