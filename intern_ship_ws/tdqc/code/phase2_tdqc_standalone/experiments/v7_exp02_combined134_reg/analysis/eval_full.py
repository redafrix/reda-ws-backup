"""Full eval for v7_exp02_combined134_reg."""
...
ROOT     = Path(".")
EXP      = ROOT / "experiments/v7_exp02_combined134_reg"
...
def run_eval():
    ...
    # ── Summary ───────────────────────────────────────────────────────────────────
    print(f"\n{'='*55}")
    print(f"SUMMARY — v7_exp02_combined134_reg")
    print(f"{'='*55}")
    ...
    print(f"{'='*55}")
    print("\nAll plots saved to experiments/v7_exp02_combined134_reg/plots/")
