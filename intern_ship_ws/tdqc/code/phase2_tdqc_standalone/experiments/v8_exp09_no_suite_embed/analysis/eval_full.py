"""Full eval for v8_exp09_no_suite_embed (Ablation)."""
...
def run_eval():
    ...
    test_set    = TDQCDataset(str(ROOT / "data/v8_balanced/v8_test.pt"))
    ...
    fig.suptitle("TDQC v8 Exp09 — No Suite Embed (Ablation) (test set)", fontsize=13, fontweight="bold")
    ...
    # ── Summary ───────────────────────────────────────────────────────────────────
    print(f"\n{'='*55}")
    print(f"SUMMARY — v8_exp09_no_suite_embed")
    print(f"{'='*55}")
