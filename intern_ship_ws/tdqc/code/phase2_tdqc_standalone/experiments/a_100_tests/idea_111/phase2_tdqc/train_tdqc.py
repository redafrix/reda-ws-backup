...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for batch in train_loader:
            ...
            # Weighted toward end of sequence
            weights = torch.linspace(0.5, 2.0, x.size(1), device=x.device).view(1, -1)
            loss = tdqc_brier_td_loss(q_online, q_target, batch["failure"], batch["lengths"], batch["mask"] * weights)
