...
def evaluate():
    ...
    eps = data['episodes']
    loader = DataLoader(EvalDataset(eps), batch_size=512, collate_fn=collate, num_workers=4)
    results = {}
    ...
    for i in range(1, 101):
        ...
        except Exception as e: print(f'Error evaluating Idea {idea_id}: {e}')
    with open('eval_results_all_progress.json', 'w') as f:
