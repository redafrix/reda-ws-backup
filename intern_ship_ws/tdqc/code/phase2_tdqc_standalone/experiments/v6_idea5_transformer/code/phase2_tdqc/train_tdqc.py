...
from phase2_tdqc.tdqc_model import TDQCLSTMCalibrator, TDQCTransformerCalibrator, hard_update
...
def parse_args():
    ...
    p.add_argument("--model_type", type=str, choices=["lstm", "transformer"], default="lstm")
