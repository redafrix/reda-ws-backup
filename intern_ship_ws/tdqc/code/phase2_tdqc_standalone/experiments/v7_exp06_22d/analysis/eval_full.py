...
ROOT     = Path(".")
EXP      = ROOT / "experiments/v7_exp06_22d"
...
def run_eval():
    ...
    fig.suptitle("TDQC v7 Exp06 — Delta + Task Embed (Large)  (test set)", fontsize=13, fontweight="bold")
    ...
    fig2.suptitle("TDQC v7 Exp06 — Per-step accuracy at fixed thresholds", fontsize=13)
    ax3 = axes2[0]
    for tau in THRESHOLDS:
    ...
    if history_file.exists():
        ...
        ax5.set_title("v7 Exp06 — Training curve (Delta + Task Embed (Large))")
    ...
    print(f"{'='*55}")
    print("\nAll plots saved to experiments/v7_exp06_22d/plots/")
