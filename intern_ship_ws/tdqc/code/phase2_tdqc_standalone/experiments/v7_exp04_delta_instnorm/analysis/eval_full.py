"""Full eval for v7_exp04_delta_instnorm."""
...
ROOT     = Path(".")
EXP      = ROOT / "experiments/v7_exp04_delta_instnorm"
...
def run_eval():
    ...
    fig.suptitle("TDQC v7 Exp04 — Causal Delta + InstNorm  (test set)", fontsize=13, fontweight="bold")
    ...
    if history_file.exists():
        ...
        ax5.set_title("v7 Exp04 — Training curve (Causal Delta + InstNorm)")
    ...
    # ── Summary ───────────────────────────────────────────────────────────────────
    print(f"\n{'='*55}")
    print(f"SUMMARY — v7_exp04_delta_instnorm")
    print(f"{'='*55}")
    ...
    print(f"{'='*55}")
    print("\nAll plots saved to experiments/v7_exp04_delta_instnorm/plots/")
