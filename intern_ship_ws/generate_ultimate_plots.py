...
log_paths = [
    'intern_ship_ws/runs/tdqc_calibrator/training.log',
    'intern_ship_ws/runs/tdqc_calibrator/fine_tuning.log',
    'intern_ship_ws/runs/tdqc_calibrator/final_stretch.log'
]
output_plot = 'intern_ship_ws/runs/tdqc_calibrator/full_1000_epoch_analysis.png'
...
ax1.set_title(f'Ultimate 1000-Epoch TDQC Calibration Analysis')
...
# Annotate milestones
ax2.text(100, 0.23, 'Initial (LR 1e-4)', rotation=0, fontweight='bold')
ax2.text(400, 0.16, 'Fine-Tune (LR 5e-5)', rotation=0, fontweight='bold')
ax2.text(800, 0.11, 'Final Polish', rotation=0, fontweight='bold')
...
textstr = '\n'.join((
    ...
    f'Total Improvement: {((DATASET_MEAN_BASELINE - FINAL_TEST_BRIER) / DATASET_MEAN_BASELINE * 100):.1f}%'
))
