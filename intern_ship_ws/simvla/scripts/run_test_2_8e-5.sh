...
OUTPUT_DIR="$WS_ROOT/outputs/runs/sweep_test_2_lr_8e-5"
LOG_FILE="$OUTPUT_DIR/sweep_test_2.log"

# Ensure output directory exists
mkdir -p "$OUTPUT_DIR"

# Training Parameters for Test 2
...
echo "=========================================================="
echo "🚀 Starting LR Sweep Test 2: LR=8e-5"
