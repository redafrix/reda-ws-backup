...
def select_argmin_on_alarm(
    ...
    *,
    ...
    """Final LIBERO-style argmin-on-alarm + selected-risk-cap rule, margin=0."""
...
class OnlineRiskSelector:
    def __init__(
        ...
        *,
        ...
        main_threshold_name: str,
        selected_cap_name: str,
        device: str,
    ) -> None:
        import torch
        ...
        self.thresholds_sha256 = sha256_file(self.thresholds_path)
