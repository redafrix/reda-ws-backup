...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--online-role", choices=("shadow", "full150"), required=True)
...
def run_collection(args: argparse.Namespace, simulation_app: Any) -> None:
    ...
    run_manifest["online_risk_intervention"] = {
        ...
        "ood150_used_for_controller_pair_selection": args.online_role == "full150",
        "evaluation_scope": "full_locked_ood150",
