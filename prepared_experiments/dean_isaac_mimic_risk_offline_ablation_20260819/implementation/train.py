...
def train_single_seed(
    ...
    split_indices = np.load(derived_dir / "split_index.npy")  # 0=train, 1=val, 2=test
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        # Strict selection: highest val AUPRC, earliest epoch on tie
...
def main() -> None:
    ...
    for s in args.seeds:
        ...
        print(f"Seed {s} Done! Best Epoch: {res[best_epoch]}, Val AUPRC: {res[best_val_auprc]:.4f}")
