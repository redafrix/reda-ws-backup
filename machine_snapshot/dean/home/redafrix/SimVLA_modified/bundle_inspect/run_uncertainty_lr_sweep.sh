...
# Paths
# =============================================================================
PRETRAINED_CKPT="${PRETRAINED_CKPT:-/home/redafrix/models/SimVLA-LIBERO}"
...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT/runs/simvla_libero_uncertainty}"

# =============================================================================
# Training setup
# =============================================================================
LEARNING_RATE="${LEARNING_RATE:-1e-4}"   # SimVLA default
