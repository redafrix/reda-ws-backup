"""Full eval for v8_exp08_balanced."""
...
def run_eval():
    ...
    fig.suptitle("TDQC v7 Exp07 — Delta + Task Embed (Large)  (test set)", fontsize=13, fontweight="bold")
    ...
    # ── Summary ───────────────────────────────────────────────────────────────────
    print(f"\n{'='*55}")
    print(f"SUMMARY — v8_exp08_balanced")
    print(f"{'='*55}")
    ...
    print(f"{'='*55}")
    print("\nAll plots saved to experiments/v8_exp08_balanced/plots/")
