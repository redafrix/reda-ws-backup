...
ROOT = Path("/home/dean/fiper_uncertainty_collection/realtime_deployment/ood_gate_experiments_20260610/selected_cap_t03_c04_10ep_20260610")
...
def main() -> None:
    ...
    (ROOT / "configs" / "seed_plan.json").write_text(
        json.dumps(
            {
                "reset_seeds": seeds,
                "seed_policy": "new Dean local paired seeds, disjoint from Bob/Sam 0..109 sweeps",
                "global_action_seed": 906100920,
                "model_load_seed": 906100911,
            },
            indent=2,
