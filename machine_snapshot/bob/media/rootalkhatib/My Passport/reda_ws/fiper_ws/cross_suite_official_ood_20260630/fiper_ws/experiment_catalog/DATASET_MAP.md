...
| **Training Source** | Sam official `libero_goal_object` H10 uncertainty dataset stopped at about 4,469 episodes and transferred to Bob under `source_seen_goal_object_from_sam_20260630`. |
...
| **Status** | Running as of 2026-06-30 13:58 CEST. First smoke passed schema validation: H10, ACE8, 49D uncertainty, saved state NPZ files. |
