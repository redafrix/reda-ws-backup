...
RUN_DIR="$ROOT/realtime_deployment/runs/chunk_exec_pilot_20260605_bob_task7"
...
python3 "$ROOT/realtime_deployment/scripts/run_baseline_simvla_chunk_exec_v2.py" \
  --config "$ROOT/realtime_deployment/configs/chunk_exec_pilot_20260605_bob_baseline.json" \
...
python3 "$ROOT/realtime_deployment/scripts/run_riskaware_simvla_chunk_exec_topk8_v2_chunk.py" \
  --config "$ROOT/realtime_deployment/configs/chunk_exec_pilot_20260605_bob_risk_topk8.json" \
