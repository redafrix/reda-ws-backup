...
- **Catalog ID:** `dean:experiments/dean_ood_last2_taskids_full_v1_20260601/ood_last2_taskids_full/base`
- **Host:** `dean`
- **Kind:** `offline_result`
- **Status:** `artifacts_only_or_unknown`
- **Original path:** `/home/dean/fiper_uncertainty_collection/experiments/dean_ood_last2_taskids_full_v1_20260601/ood_last2_taskids_full/base`
...
- Files: `5`
- Total size: `2.5 MiB`
- Latest modification: `2026-06-01T14:30:08.854128+00:00`
...
Connect to `dean` and inspect `/home/dean/fiper_uncertainty_collection/experiments/dean_ood_last2_taskids_full_v1_20260601/ood_last2_taskids_full/base`.
