...
- **Catalog ID:** `bob:realtime_deployment/runs/baseline_same_seed_4worker_20260601/bob_w1_fold00_unseen_alphabet_soup_t0`
- **Host:** `bob`
- **Kind:** `realtime_result`
- **Status:** `inactive_with_results`
- **Original path:** `/media/rootalkhatib/My Passport/reda_ws/fiper_ws/realtime_deployment/runs/baseline_same_seed_4worker_20260601/bob_w1_fold00_unseen_alphabet_soup_t0`
...
- Files: `6`
- Total size: `16.2 MiB`
- Latest modification: `2026-06-01T15:42:32.220000+00:00`

## Navigation

Connect to `bob` and inspect `/media/rootalkhatib/My Passport/reda_ws/fiper_ws/realtime_deployment/runs/baseline_same_seed_4worker_20260601/bob_w1_fold00_unseen_alphabet_soup_t0`.
