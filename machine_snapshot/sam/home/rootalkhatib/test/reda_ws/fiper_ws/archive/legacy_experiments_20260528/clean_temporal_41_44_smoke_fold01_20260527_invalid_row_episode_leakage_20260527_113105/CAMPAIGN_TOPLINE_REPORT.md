...
|---:|---|---|---|---:|---:|---:|---:|
| 1 | `clean_041_tcn_k8_no_object_no_reward_success` | supervised | seq_tcn | 0.0000 | 0.00% | 0.00% | 0.00% |
| 2 | `clean_044_lstm_k8_no_object_no_reward_success` | supervised | seq_lstm | 0.0000 | 0.00% | 0.00% | 0.00% |
