...
TASKS = range(18)
MODELS = [
    {"label": "original_simvla", "checkpoint": "/home/rootalkhatib/test/reda_ws/fiper_ws/checkpoints/original_simvla_libero/YuankaiLuo_SimVLA-LIBERO", "policy": "simvla_only"},
    {"label": "modified_simvla", "checkpoint": "/home/rootalkhatib/test/reda_ws/fiper_ws/checkpoints/ckpt-60000", "policy": "simvla_only"},
    {"label": "risk_topk8_selected_cap", "checkpoint": "/home/rootalkhatib/test/reda_ws/fiper_ws/checkpoints/ckpt-60000", "policy": "risk_topk8"}
]
    ...
    for task_id in TASKS:
        for model in MODELS:
            ...
            if model["policy"] == "risk_topk8":
                ...
                cfg["selection_max_selected_score"] = 0.4
