...
from phase2_tdqc.model import TDQCCalibrator, hard_update, predict_tdqc_sequence, soft_update, td0_brier_loss
...
def main() -> None:
    ...
    if args.external_val_dataset_path is not None:
        ...
        if args.add_temporal_features:
            external_episodes, external_feature_keys = add_temporal_features(
                external_episodes,
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for batch in train_loader:
            ...
            global_step += 1
            if not use_fixed_horizon_training:
