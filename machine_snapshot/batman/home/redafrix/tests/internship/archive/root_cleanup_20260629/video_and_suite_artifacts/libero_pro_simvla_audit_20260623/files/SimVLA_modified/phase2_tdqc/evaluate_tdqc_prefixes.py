...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--prefix_steps", type=int, nargs="+", default=[100, 120])
...
def prepare_episodes(dataset_path: str | Path, ckpt: dict[str, Any]) -> list[dict[str, Any]]:
...
def main() -> None:
    ...
    for ckpt_path in args.checkpoint:
        ...
        episodes = prepare_episodes(args.dataset_path, ckpt)
