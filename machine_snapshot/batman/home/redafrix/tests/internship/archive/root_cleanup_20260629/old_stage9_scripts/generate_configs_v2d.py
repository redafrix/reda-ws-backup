...
MODELS = [
    {
        "label": "topk8_v2d_commit_gate",
        "checkpoint": "/home/rootalkhatib/test/reda_ws/fiper_ws/trash/h10_goal_object_ood_all_tasks_10ep_topk8_v2d_commit_gate_20260610/checkpoints/ckpt-60000",
...
def run():
    ...
    for task_id in TASKS:
        for model in MODELS:
            ...
            if model["policy"] == "topk8_v2d_commit_gate":
