...
POLICIES = ["simvla_only", "shadow_base", "risk_base", "shadow_topk8", "risk_topk8", "topk8_v2b_adaptive_horizon"]
...
def run_episode(
    ...
    if policy != "topk8_v2b_adaptive_horizon" and execution_horizon not in {1, 10}:
    ...
    try:
        ...
        while num_steps < max_steps and not success:
            ...
            chosen_horizon_val = chosen_horizon if policy == "topk8_v2b_adaptive_horizon" else execution_horizon
...
def main() -> None:
    ...
    elif args.policy in {"shadow_topk8", "risk_topk8", "topk8_v2b_adaptive_horizon"}:
