...
TASKS = range(18)
MODELS = [
    {"label": "modified_simvla", "checkpoint": "/home/rootalkhatib/test/reda_ws/fiper_ws/trash/h10_goal_object_ood_all_tasks_10ep_topk8_v2b_feature_preserving_adaptive_horizon_20260610/checkpoints/ckpt-60000", "policy": "simvla_only"},
    {"label": "topk8_v2b_adaptive_horizon", "checkpoint": "/home/rootalkhatib/test/reda_ws/fiper_ws/trash/h10_goal_object_ood_all_tasks_10ep_topk8_v2b_feature_preserving_adaptive_horizon_20260610/checkpoints/ckpt-60000", "policy": "topk8_v2b_adaptive_horizon"}
]
...
def run():
    ...
    for task_id in TASKS:
        for model in MODELS:
            ...
            if model["policy"] == "topk8_v2b_adaptive_horizon":
