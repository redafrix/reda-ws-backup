...
EVAL="$WS/src/eval_pi05_official_suite_two_heads_20260625.py"
SEEDS="$WS/configs/pi05_goal_swap_50_seed_list_20260625.json"
ONLINE_ROOT="$WS/online_evals/pi05_official_goal_swap_10task_50ep_basic_then_selected_cap_q95mass02_20260625"
OFFLINE_OUT="$WS/offline_risk_experiments/pi05_official_goal_swap_10task_50ep_two_heads_eval_20260625"
LOG_DIR="$WS/logs/pi05_official_goal_swap_10task_50ep_basic_then_selected_cap_q95mass02_20260625"
...
echo "[pipeline] $(date) starting official Pi0.5 libero_goal_swap 10-task 50ep run"
