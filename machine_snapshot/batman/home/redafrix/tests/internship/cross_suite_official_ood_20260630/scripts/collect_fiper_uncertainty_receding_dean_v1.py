...
def make_env(benchmark_dict: dict[str, Any], get_libero_path_fn: Any, offscreen_cls: Any, suite: str, task_id: int, resolution: int, env_seed: int):
    ...
    if task.problem_folder == "libero_goal_object_ood":
        # This LIBERO-PRO checkout stores the OOD BDDL files under the
        # historical *_temp folder while the matching official init states live
        # under libero_goal_object_ood. Try both without modifying the repo.
