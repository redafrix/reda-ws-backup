...
OUTPUT_ROOT="experiments/clean_temporal_nextgen_v2_smoke_all_20260527"
LOG_DIR="logs/nextgen_v2_smoke_all_20260527"
...
for refs in "${REFS_DIRS[@]}"; do
  ...
  echo "=== SMOKE ${split_name} ===" | tee "$log_file"
...
echo "=== NEXTGEN V2 SMOKE ALL SPLITS COMPLETE ==="
