...
### H10 TopK8 Aggressive Ablation (2026-06-08)

The H10 campaign is concluding with a successful aggressive ablation study. Threshold 0.3 on the `unc_topk8` detector provided a +5% success boost on Task 6 and +2% on Task 3. The H10-specific detectors are now the recommended choice for execution horizon 10 deployments.
