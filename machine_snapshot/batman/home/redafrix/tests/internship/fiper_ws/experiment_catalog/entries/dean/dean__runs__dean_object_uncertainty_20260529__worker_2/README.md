...
- **Catalog ID:** `dean:runs/dean_object_uncertainty_20260529/worker_2`
- **Host:** `dean`
- **Kind:** `collection_result`
- **Status:** `inactive_with_results`
- **Original path:** `/home/dean/fiper_uncertainty_collection/runs/dean_object_uncertainty_20260529/worker_2`
...
|---|---:|---:|---:|---:|---:|---:|
| `runs/dean_object_uncertainty_20260529/worker_2/episode_summaries.jsonl` | 1084 | 823 | 261 | 34 | 0 | 158.38 |
...
- Files: `171700`
- Total size: `7.8 GiB`
- Latest modification: `2026-06-01T09:41:35.688585+00:00`

## Navigation

Connect to `dean` and inspect `/home/dean/fiper_uncertainty_collection/runs/dean_object_uncertainty_20260529/worker_2`.
