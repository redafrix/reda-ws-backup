...
- **Catalog ID:** `bob:realtime_deployment/runs/canonical_dean_bob_task0_4policy_seq100_20260604/03_risk_base/risk_base`
- **Host:** `bob`
- **Kind:** `realtime_result`
- **Status:** `inactive_with_results`
- **Original path:** `/media/rootalkhatib/My Passport/reda_ws/fiper_ws/realtime_deployment/runs/canonical_dean_bob_task0_4policy_seq100_20260604/03_risk_base/risk_base`
...
- Files: `4`
- Total size: `18.7 MiB`
- Latest modification: `2026-06-04T17:35:34.140000+00:00`

## Navigation

Connect to `bob` and inspect `/media/rootalkhatib/My Passport/reda_ws/fiper_ws/realtime_deployment/runs/canonical_dean_bob_task0_4policy_seq100_20260604/03_risk_base/risk_base`.
