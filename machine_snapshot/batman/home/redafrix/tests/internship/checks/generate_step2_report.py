# Let's create the final step 2 report
import json

report = """# Forensic Sanity Audit Report: Step 2 - Data & Leakage Investigation
...
# Write local file
with open("/home/redafrix/tests/internship/H10_RISK_AWARE_FORENSIC_SANITY_AUDIT_STEP2_DATA_AND_LEAKAGE_20260609.md", "w") as f:
    f.write(report)

print("Step 2 Report compiled locally.")
